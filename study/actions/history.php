...
if ($_POST['action'] == 'searchDatePeriod'){
    ...
    // Convert to Y-m-d
    $start_date = DateTime::createFromFormat('d/m/Y', $start_date_input)->format('Y-m-d');
    $end_date = DateTime::createFromFormat('d/m/Y', $end_date_input)->format('Y-m-d');

    if ($start_date == $end_date) {
        // Same day range from 00:00 to 23:59
        $start_datetime = $start_date . ' 00:00:00';
        $end_datetime = $end_date . ' 23:59:59';
    } else {
        // Different dates range
        $start_datetime = $start_date . ' 00:00:00';
        $end_datetime = $end_date . ' 23:59:59';
    }
