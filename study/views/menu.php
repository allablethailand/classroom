...
session_start();
// print_r($_SESSION['join_info']['group_id']);
// exit;
//  // สำคัญมาก: ต้องเรียกใช้ session_start() ก่อนการใช้งาน Session ทุกครั้ง
...
// if (!isset($_SESSION['student_id']) || !isset($_SESSION['join_id'])) 
