<?php
    ...
    // --- 2. Build the query to fetch students based on the selected group ---
    $query_parts = [
        "SELECT cs.student_id, cs.student_firstname_th, cs.student_lastname_th, cs.student_image_profile, cs.student_mobile, cs.student_email, cs.student_education, cs.student_company, cs.student_position",
        ...
        <div class="student-list">
            ...
            <a href="studentinfo?id=<?= htmlspecialchars($row['student_id']); ?>" class="student-card">
                ...
                <div class="student-info">
                    ...
                    <?php if (!empty($row['student_education'])) { ?>
                        <p class="student-details">
                            <i class="fas fa-graduation-cap"></i> <?= htmlspecialchars($row['student_education']); ?>
                        </p>
                    <?php } ?>
                    <?php if (!empty($row['student_company'])) { ?>
                        <p class="student-details">
                            <i class="fas fa-building"></i> <?= htmlspecialchars($row['student_company']); ?>
                        </p>
                    <?php } ?>
                    <?php if (!empty($row['student_position'])) { ?>
                        <p class="student-details">
                            <i class="fas fa-briefcase"></i> <?= htmlspecialchars($row['student_position']); ?>
                        </p>
                    <?php } ?>
                    <?php if (!empty($row['student_mobile'])) { ?>
                        <p class="student-details">
                            <i class="fas fa-phone"></i> <?= htmlspecialchars($row['student_mobile']); ?>
                        </p>
                    <?php } ?>
                    <?php if (!empty($row['student_email'])) { ?>
                        <p class="student-details">
                            <i class="fas fa-envelope"></i> <?= htmlspecialchars($row['student_email']); ?>
                        </p>
                    <?php } ?>
                </div>
            </a>
