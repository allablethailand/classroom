 $(document).ready(function() {
    ...
    $('.notification-item').on('click', function(e) {
        ...
        $('#notificationModalContainer').modal('show');

        // SEND REQUEST TO UPDATE THE NOTIFICATION
...
//         // console.log("Debugging notification click:", message);
//         // // console.log($('.notification-item').first().data('message'));

//         // // console.log($('.notification-item').length);
//         // $('.notification-item').click();
        
//         // console.log("Notification clicked. Message: " + message);

//         // // // 1. Check if elements exist
//         // console.log($('.notification-item').length); // Should be > 0

//         // // 2. Check if data attribute exists
//         // console.log($('.notification-item').first().data('message'));

//         // // 3. Verify Bootstrap modal works manually
//         // $('#notificationModal').modal('show'); // Should open modal

//         // 4. Test event binding directly
//         $('.notification-item').click(); // Should trigger your handler
...
//         var $menu = $(this).next("#notificationModal");
//         console.log($menu);
//         if (!isExpanded) {
//         if (!$menu.data("loaded")) {
//             $.ajax({
