...
//  onclick="redirectCurreculum('${course.course_id}', '${course.course_type}', ${classroomId})"

  return `

      <div class="col-xs-12 col-md-4 col-lg-4">
        <a href="classinfo?course_id=${course.course_id}&class_id=${classroomId}&course_type=${course.course_type}&class_type" style="text-decoration: none; color: inherit;">
